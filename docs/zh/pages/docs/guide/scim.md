...
1. 创建新的 SCIM 集成或选择现有的自定义应用程序。
   ...
   对于 SAML SSO，创建单独的私有 SCIM 集成。您现有的模态框
   应用程序可以继续处理SSO；不要将 SSO 添加到新的 SCIM 集成中。
...
1. 创建或选择企业应用程序。
   ...
   * 否则，请转到“Entra ID > 企业应用程序”并创建应用程序：
     ...
     3. 选择“集成您在库中找不到的任何其他应用程序”（非画廊）”并创建应用程序。
...
1. 创建自定义 SCIM 集成。
   ...
   SCIM 集成必须是一个单独的应用程序，具体取决于您的 IdP。2. 配置与您的 Modal SCIM 凭据的集成。
