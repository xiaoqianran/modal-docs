...
| `workspace.update_idp`                       | A workspace's identity provider (Okta) configuration was changed. Enabling SSO enforcement immediately logs out any non-Okta sessions.                                                                                                                              |
