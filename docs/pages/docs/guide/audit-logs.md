...
| `workspace.upload_identity_provider_metadata` | A SAML metadata document was uploaded for a workspace, replacing any file Modal already hosted for it. This sets the workspace's SSO metadata URL and the identity provider whose sign-ins Modal will accept.                                                       |
