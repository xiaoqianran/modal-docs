...
You need to explicitly reload a Volume to see changes made since it was first mounted, by invoking the [.reload\_volumes()](/docs/sdk/py/latest/Sandbox#reload_volumes) method on the sandbox object.
